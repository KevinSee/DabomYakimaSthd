...
To run the DABOM model, we need to write the text file containing the structure for the Yakima DABOM model that the JAGS software will use. The `DABOM` R package contains a function `writeDABOM_PRO` to write a generic version for the Prosser Dam DABOM:
